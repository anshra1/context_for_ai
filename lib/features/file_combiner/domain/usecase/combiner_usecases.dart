...
class CombineFiles extends FutureUseCaseWithParams<CombineFilesResult, CombineFilesParams> {
  CombineFiles({required this.repository});

  final CombinerRepository repository;

  @override
  ResultFuture<CombineFilesResult> call(CombineFilesParams params) {
